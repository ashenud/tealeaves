    ...
    <div class="container">
            ...
            <table width="98%" class="table data-table table-hover">
                <thead>
                    <tr>
                        ...
                        <th width="18%" scope="col">Loan Date</th>
                ...
                <tfoot>
                    <tr>
                        <th colspan="2"></th>
                        <th style="text-align: right" colspan="2">Monthly Other Total Total</th>
                        ...
                        <div class="form-area">
                            <table class="table insert-table">
                                <tr>
                                    <td>Date</td>
                                    <td> : </td>
                                    <td><input type="date" id="date" class="form-control" min="{{ date('Y-m-01',strtotime($data['loan_month'])) }}" max="{{ date('Y-m-t',strtotime($data['loan_month'])) }}"></td>
                                </tr>
                                <tr>
                                    <td>Supplier No.</td>
                                    <td> : </td>
        ...
        <div class="modal fade" id="edit_model" aria-labelledby="edit_model_Label" data-mdb-backdrop="static" data-mdb-keyboard="false" aria-hidden="true">
            <div class="modal-dialog .modal-side .modal-top-right">
                <div class="modal-content custom-modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="edit_model_Label">INSERT LOAN DETAILS</h5>
                        <button type="button" class="btn-close" data-mdb-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="form-area">
                            <table class="table insert-table">
                                <tr>
                                    <td>Date</td>
                                    <td> : </td>
                                    <td><input type="date" id="date2" class="form-control" min="{{ date('Y-m-01',strtotime($data['loan_month'])) }}" max="{{ date('Y-m-t',strtotime($data['loan_month'])) }}"></td>
                                </tr>
                                <tr>
                                    <td>Supplier No.</td>
                                    <td> : </td>
...
<script>    
    ...
    function loanDatatable() {
        ...
        if(loan_month.match(regEx)) {
            var apiURL = baseURL+'admin/loan-datatable/'+loan_month;
            // console.log(apiURL);
        }
